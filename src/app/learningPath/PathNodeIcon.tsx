...
export function PathNodeIcon({ kind }: { kind: StageType | "chapter" | "lock" | "check" }) {
...
export function StageStars({ stars }: { stars: number }) {
  return <span className="path-stars" role="img" aria-label={`${stars} מתוך 3 כוכבים`}>
