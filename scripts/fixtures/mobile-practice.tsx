...
export function Fixture() {
  const [session] = useState(() => ({ id: crypto.randomUUID(), studentId: "mobile-test", selectedSkillIds: skills.map(item => item.id), settings, startedAt: Date.now() - (params.has("missing") ? 24000 : 0) }));
